...
export class NgbCarousel implements AfterContentChecked,
   ...
   */
  @Output() slide = new EventEmitter<NgbSlideCarouselEvent>();
  ...
  cycleToNext() { this.cycleToSelected(this._getNextSlide(this.activeId), NgbSlideCarouselEventDirection.LEFT); }

  cycleToPrev() { this.cycleToSelected(this._getPrevSlide(this.activeId), NgbSlideCarouselEventDirection.RIGHT); }

  cycleToSelected(slideIdx: string, direction: NgbSlideCarouselEventDirection) {
  ...
  private _getSlideEventDirection(currentActiveSlideId: string, nextActiveSlideId: string):
      NgbSlideCarouselEventDirection {
    const currentActiveSlideIdx = this._getSlideIdxById(currentActiveSlideId);
    const nextActiveSlideIdx = this._getSlideIdxById(nextActiveSlideId);

    return currentActiveSlideIdx > nextActiveSlideIdx ? NgbSlideCarouselEventDirection.RIGHT :
                                                        NgbSlideCarouselEventDirection.LEFT;
  }
}
...
*/
export interface NgbSlideCarouselEvent {
  /**
   * Previous slide id
   */
  prev: string;
   ...
   */
  direction: NgbSlideCarouselEventDirection;
}
