...
import {getMonthSelect, getYearSelect, getNavigationLinks, ADAPTERS, SupportedDate} from '../test/datepicker/common';
...
function customizeConfig(config: NgbDatepickerConfig) {
  config.dayTemplate = {} as TemplateRef<DayTemplateContext<any>>;
...
ADAPTERS.forEach(adapter => {
  ...
  describe(`ngb-datepicker (${adapter.type.name})`, () => {

    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [TestComponent],
        imports: [NgbDatepickerModule.forRoot(), FormsModule, ReactiveFormsModule],
    ...
    it('should initialize inputs with provided config', () => {
      ...
      const datepicker = TestBed.createComponent(NgbDatepicker).componentInstance as NgbDatepicker;
    ...
    it('should allow setting minDate separately', () => {
      ...
      fixture.componentInstance.minDate = fromStruct({year: 2000, month: 5, day: 20});
      fixture.detectChanges();
      expect(getMonthSelect(fixture.nativeElement).value).toBe('8');
      expect(getYearSelect(fixture.nativeElement).value).toBe('2016');
    ...
    it('should allow setting maxDate separately', () => {
      ...
      fixture.componentInstance.maxDate = fromStruct({year: 2050, month: 5, day: 20});
      fixture.detectChanges();
      expect(getMonthSelect(fixture.nativeElement).value).toBe('8');
      expect(getYearSelect(fixture.nativeElement).value).toBe('2016');
    ...
    it('should handle minDate edge case values', () => {
      ...
      // resetting
      fixture.componentInstance.minDate = fromStruct({year: 3000000, month: 1, day: 1});
      expectMinDate(1000, 1);
    ...
    it('should handle maxDate edge case values', () => {
      ...
      // resetting
      fixture.componentInstance.maxDate = fromStruct({year: 3000000, month: 1, day: 1});
      expectMaxDate(10000, 1);
    ...
    it('should support disabling dates via min/max dates', () => {
      ...
      fixture.componentInstance.minDate = fromStruct({year: 2016, month: 8, day: 20});
      fixture.componentInstance.maxDate = fromStruct({year: 2016, month: 8, day: 25});
      fixture.detectChanges();
    ...
    describe('ngModel', () => {
      ...
      it('should update model based on calendar clicks', async(() => {
           ...
           expect(fixture.componentInstance.model).toEqual(fromStruct({year: 2016, month: 8, day: 1}));

           dates[1].click();
           expect(fixture.componentInstance.model).toEqual(fromStruct({year: 2016, month: 8, day: 2}));
         }));
      ...
      it('select calendar date based on model updates', async(() => {
           ...
           fixture.componentInstance.model = fromStruct({year: 2016, month: 8, day: 1});
           ...
           fixture.whenStable()
               ...
               .then(() => {
                 ...
                 fixture.componentInstance.model = fromStruct({year: 2016, month: 8, day: 2});
                 fixture.detectChanges();
                 return fixture.whenStable();
               })
               .then(() => {
      ...
      it('should switch month when clicked on the date outside of current month', async(() => {
           ...
           fixture.whenStable().then(() => {
             ...
             expect(fixture.componentInstance.model).toEqual(fromStruct({year: 2016, month: 9, day: 1}));
      ...
      it('should switch month on prev/next navigation click', async(() => {
           ...
           expect(fixture.componentInstance.model).toEqual(fromStruct({year: 2016, month: 7, day: 1}));
      ...
      it('should switch month using navigateTo({date})', async(() => {
       ...
       <button id="btn"(click)="dp.navigateTo({year: 2015, month: 6})"></button>`);
           ...
           expect(fixture.componentInstance.model).toEqual(fromStruct({year: 2015, month: 6, day: 1}));
         }));
    ...
    describe('Custom config', () => {
      ...
      it('should initialize inputs with provided config', () => {
        ...
        const datepicker = fixture.componentInstance as NgbDatepicker;
  ...
  class TestComponent {
    ...
    displayMonths = 1;
    navigation = 'select';
    minDate: SupportedDate = fromStruct({year: 2010, month: 1, day: 1});
    maxDate: SupportedDate = fromStruct({year: 2020, month: 12, day: 31});
    form = new FormGroup({control: new FormControl('', Validators.required)});
    disabledForm = new FormGroup({control: new FormControl({value: null, disabled: true})});
    model;
    showWeekdays = true;
    markDisabled = (date: SupportedDate) => NgbDate.from(toStruct(date)).equals(new NgbDate(2016, 8, 22));
    onNavigate = () => {};
    onSelect = () => {};
  }
