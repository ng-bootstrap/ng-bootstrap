...
describe('ngb-popover', () => {
  ...
  describe('basic functionality', () => {
    ...
    it('should not show a header if title is empty', fakeAsync(() => {
    ...
    it('should not open a popover if content and title are empty', fakeAsync(() => {
    ...
    it('should not open a popover if [disablePopover] flag', fakeAsync(() => {
    ...
    it('should open the popover if content is empty but title has value', fakeAsync(() => {
    ...
    it('should not close the popover if content becomes empty but title has value', fakeAsync(() => {
         const fixture = createTestComponent(`<div [ngbPopover]="name" popoverTitle="title"></div>`);
         const directive = fixture.debugElement.query(By.directive(NgbPopover));
  ...
  describe('positioning', () => {
    ...
    it('should accept placement in array(second value of the array should be applied)', fakeAsync(() => {
         const fixture =
             createTestComponent(`<div ngbPopover="Great tip!" [placement]="['left-top','top-right']"></div>`);
         const directive = fixture.debugElement.query(By.directive(NgbPopover));
  ...
  describe('visibility', () => {
    ...
    it('should not emit close event when already closed', fakeAsync(() => {
         const fixture = createTestComponent(
  ...
  describe('triggers', () => {
    ...
    it('should support multiple triggers', fakeAsync(() => {
         const fixture =
             createTestComponent(`<div ngbPopover="Great tip!" triggers="mouseenter:mouseleave click"></div>`);
         const directive = fixture.debugElement.query(By.directive(NgbPopover));
