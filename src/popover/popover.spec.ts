...
describe('ngb-popover-window', () => {
  beforeEach(() => {
    TestBed.configureTestingModule(
        {declarations: [TestComponent], imports: [NgbPopoverModule.forRoot(), NoopAnimationsModule]});
  });
...
describe('ngb-popover', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      imports: [NgbPopoverModule.forRoot(), NoopAnimationsModule],
  ...
  describe('container', () => {
    ...
    it('should be appended to the element matching the selector passed to "container"', fakeAsync(() => {
         ...
         // close the popover, otherwise it interferes with the next test
         directive.triggerEventHandler('click', {});
         fixture.detectChanges();
         flush();
  ...
  describe('Custom config', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({imports: [NgbPopoverModule.forRoot(), NoopAnimationsModule]});
