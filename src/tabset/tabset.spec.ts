...
describe('ngb-tabset', () => {
  ...
  it('should render tabs and select first tab as active by default', () => {
    const fixture = createTestComponent(`
      <ngb-tabset>
        <ngb-tab title="foo"><ng-template ngbTabContent>Foo</template></ngb-tab>
        <ngb-tab title="bar"><ng-template ngbTabContent>Bar</template></ngb-tab>
      </ngb-tabset>
    `);
  ...
  it('should allow mix of text and HTML in tab titles', () => {
    const fixture = createTestComponent(`
      <ngb-tabset>
        <ngb-tab title="foo"><ng-template ngbTabContent>Foo</template></ngb-tab>
        <ngb-tab>
          <ng-template ngbTabTitle><b>bar</b></template>
          <ng-template ngbTabContent>Bar</template>
        </ngb-tab>
        <ngb-tab title="baz">
          <ng-template ngbTabTitle>baz</template>
          <ng-template ngbTabContent>Baz</template>
        </ngb-tab>
      </ngb-tabset>
    `);
  ...
  it('should mark the requested tab as active', () => {
    const fixture = createTestComponent(`
      <ngb-tabset activeId="2">
        <ngb-tab title="foo" id="1"><ng-template ngbTabContent>Foo</template></ngb-tab>
        <ngb-tab title="bar" id="2"><ng-template ngbTabContent>Bar</template></ngb-tab>
      </ngb-tabset>
    `);
  ...
  it('should support disabled tabs', () => {
    const fixture = createTestComponent(`
         <ngb-tabset>
           <ngb-tab title="foo"><ng-template ngbTabContent>Foo</template></ngb-tab>
           <ngb-tab title="bar" [disabled]="true"><ng-template ngbTabContent>Bar</template></ngb-tab>
         </ngb-tabset>
       `);
  ...
  it('should change active tab by calling select on an exported directive instance', () => {
    const fixture = createTestComponent(`
          <ngb-tabset #myTabSet="ngbTabset">
            <ngb-tab id="myFirstTab" title="foo"><ng-template ngbTabContent>Foo</template></ngb-tab>
            <ngb-tab id="mySecondTab" title="bar"><ng-template ngbTabContent>Bar</template></ngb-tab>
          </ngb-tabset>
  ...
  it('should not change active tab by calling select on an exported directive instance in case of disable tab', () => {
    const fixture = createTestComponent(`
          <ngb-tabset #myTabSet="ngbTabset">
            <ngb-tab id="myFirstTab" title="foo"><ng-template ngbTabContent>Foo</template></ngb-tab>
            <ngb-tab id="mySecondTab" title="bar" [disabled]="true"><ng-template ngbTabContent>Bar</template></ngb-tab>
          </ngb-tabset>
          <button (click)="myTabSet.select('mySecondTab')">Select the second Tab</button>
        `);
  ...
  it('should emit tab change event when switching tabs', () => {
    const fixture = createTestComponent(`
          <ngb-tabset #myTabSet="ngbTabset" (tabChange)="changeCallback($event)">
            <ngb-tab id="first" title="first"><ng-template ngbTabContent>First</template></ngb-tab>
            <ngb-tab id="second" title="second"><ng-template ngbTabContent>Second</template></ngb-tab>
          </ngb-tabset>
  ...
  it('should not emit tab change event when selecting currently active and disabled tabs', () => {
    const fixture = createTestComponent(`
          <ngb-tabset #myTabSet="ngbTabset" (tabChange)="changeCallback($event)">
            <ngb-tab id="first" title="first"><ng-template ngbTabContent>First</template></ngb-tab>
            <ngb-tab id="second" title="second" [disabled]="true"><ng-template ngbTabContent>Second</template></ngb-tab>
          </ngb-tabset>
          <button (click)="myTabSet.select('first')">Select the first Tab</button>
          <button (click)="myTabSet.select('second')">Select the second Tab</button>
        `);
