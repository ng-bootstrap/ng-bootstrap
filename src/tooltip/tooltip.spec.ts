import {TestBed, ComponentFixture, inject, flush, fakeAsync} from '@angular/core/testing';
...
describe('ngb-tooltip-window', () => {
  beforeEach(() => { TestBed.configureTestingModule({imports: [NgbTooltipModule.forRoot(), NoopAnimationsModule]}); });
...
describe('ngb-tooltip', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      imports: [NgbTooltipModule.forRoot(), NoopAnimationsModule]
    });
  });
  ...
  describe('basic functionality', () => {
    ...
    it('should close the tooltip tooltip if content becomes falsy', fakeAsync(() => {
    ...
    describe('triggers', () => {
      ...
      it('should not throw when closed called for manual triggers and closed tooltip', fakeAsync(() => {
           const fixture = createTestComponent(`
                <div ngbTooltip="Great tip!" triggers="manual" #t="ngbTooltip"></div>
                <button (click)="t.close()">C</button>`);
  ...
  describe('container', () => {
    ...
    it('should be appended to the element matching the selector passed to "container"', fakeAsync(() => {
         ...
         // close the tooltip, otherwise it interferes with the next test
         fixture.destroy();
         flush();
         expect(getWindow(window.document.querySelector(selector))).toBeNull();
       }));

    it('should properly destroy tooltips when the "container" option is used', fakeAsync(() => {
         const selector = 'body';
         const fixture =
  ...
  describe('visibility', () => {
    ...
    it('should not emit open event when already opened', fakeAsync(() => {
         const fixture = createTestComponent(
             `<div ngbTooltip="Great tip!" triggers="manual" (shown)="shown()" (hidden)="hidden()"></div>`);
  ...
  describe('Custom config', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({imports: [NgbTooltipModule.forRoot(), NoopAnimationsModule]});
