...
@Component({
  ...
  template: `
    <ngbd-content-wrapper component="Timepicker">
      ...
      <ngbd-example-box demoTitle="Timepicker Meridian" [htmlSnippet]="snippets.meridian.markup" [tsSnippet]="snippets.meridian.code">
        <ngbd-timepicker-meridian></ngbd-timepicker-meridian>      
      </ngbd-example-box>
      <ngbd-example-box demoTitle="Timepicker Seconds" [htmlSnippet]="snippets.seconds.markup" [tsSnippet]="snippets.seconds.code">
        <ngbd-timepicker-seconds></ngbd-timepicker-seconds>      
      </ngbd-example-box>
      <ngbd-example-box demoTitle="Timepicker Steps" [htmlSnippet]="snippets.steps.markup" [tsSnippet]="snippets.steps.code">
